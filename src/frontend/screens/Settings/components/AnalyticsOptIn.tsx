    ...
    <div className="toggleRow">
      <ToggleSwitch
        ...
        title={t(
          ...
          'Send anonymous data to help Relic development'
        )}
      />
      <InfoIcon
        text={t(
          'help.analytics',
          'Enables Relic to collect 100% anonymous usage data to help improve the application. Needs restart to take effect.'
        )}
      />
    </div>
  )
